      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h5 class="mt-1">Servidores VPS - SSD
              <a href="{{ route('create-server') }}" class="btn btn-primary btn-sm float-end">
                ...
                @foreach ($servers as $server)
                  ...
                  @if ($server->type_storage == 'SSD' AND $server->locale == 'Canadá')
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('edit-server', $server->id) }}" class="btn btn-success btn-sm">
